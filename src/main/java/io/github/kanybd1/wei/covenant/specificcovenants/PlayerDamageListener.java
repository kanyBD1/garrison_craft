...
public class PlayerDamageListener {
    ...
    public class Covenant_Fortress extends com.example.wei.covenant.specificcovenants.AbstractCovenant implements ICovenant, com.example.wei.covenant.specificcovenants.AbstractCovenantEffect {
        int stacks = 0;
